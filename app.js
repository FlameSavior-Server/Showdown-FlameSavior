...
if (Config.crashguard) {
	...
	process.on('uncaughtException', function (err) {
		...
		if (Rooms.rooms.staff) {
			Rooms.rooms.staff.addRaw('<div class="broadcast-red"><b>THE SERVER HAS CRASHED:</b> ' + stack + '<br />Please restart the server.</div>');
			Rooms.rooms.staff.addRaw('<div class="broadcast-red">You will not be able to talk in the lobby or start new battles until the server restarts.</div>');
		}
