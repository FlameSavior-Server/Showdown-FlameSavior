...
exports.commands = {
	one: function (target, room, user, connection) {
		...
		else if (!one || one === 'help' || one === 'help' || one === 'git') {
			this.sendReplyBox("For help on how to use this command, see <a href=\"https://raw.githubusercontent.com/jd4565/Pokemon-Showdown/master/chat-plugins/1v1.js\">here</a>.");
		} else {
			switch (one) {
				case 'regular':
