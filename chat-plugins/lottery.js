    ...
    lottery: function(target, room, user) {
        ...
        switch (toId(parts[0])) {
            ...
            case 'join':
                ...
                //if (Gold.lottery.maxTicketsPerUser + 1 < user.loto) return this.errorReply("You cannot get more than " + Gold.lottery.maxTicketsPerUser + " tickets for this game of lotto.");
