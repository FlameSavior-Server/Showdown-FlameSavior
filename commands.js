...
//New Room Commands
	...
	for (var u in Users.users) { if (Users.users[u].isStaff) {
		Users.users[u].send('|pm|~Staff PM|'+Users.users[u].group+Users.users[u].name+'|Attention, "'+user.userid+'" has suggested a new room.  Please meet in the staff room to talk about it.'); } 
		}
	},
