...
tour.startRaw = function(i) {
	...
	for (var i in round) {
		if (!round[i][1]) {
			...
			html += tabla + "<tr><td><span align=right>" + clean(p1n) + "</p></td><td>&nbsp;VS&nbsp;</td><td>" + clean(p2n) + "</td></tr>";
		}
	}
		...
		for (var i in r) {
			if (!r[i][1]) {
				...
				if (r[i][2] == undefined) {
					...
					if (p2n.split('Guest ').length - 1 > 0) p2n = r[i][1];
					var tabla = "";if (i == 0) var tabla = "</center><table align=center cellpadding=0 cellspacing=0>";
					html += tabla + "<tr><td><span align=right><b>" + clean(p1n) + "</b></p></td><td><b>&nbsp;VS&nbsp;</b></td><td><b>" + clean(p2n) + "</b></td></tr>";
				}
				else {
					//match completed
					var p1 = "red";
					...
					if (p2n.split('Guest ').length - 1 > 0) p2n = r[i][1];
					var tabla = "";if (i == 0) var tabla = "</center><table align=center cellpadding=0 cellspacing=0>";
					html += tabla + "<tr><td><span align=right><b><font color=\"" + p1 + "\">" + clean(p1n) + "</font></b></p></td><td><b>&nbsp;VS&nbsp;</b></td><td><font color=\"" + p2 + "\"><b>" + clean(p2n) + "</b></font></td></tr>";
				}
			}
		}
