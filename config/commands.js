...
var commands = exports.commands = {
	...
	parukiarules: function(target, room, user) {
		if (!this.canBroadcast()) return;
this.sendReplyBox('<font size="5" color="red"><b>The Kakuja-Parukia Guidelines</b></font><br><font size="3" color="red"><b>We don\'t follow the same rules as main!</b></font><br><br>1.) There is no such thing as racism on Kakuja.<br>2.) Broaken Hope and Twin Flames are Kakuja\'s OTPs(One True Pairings)!<br>3.) Playfully trolling one another is how we show we care<br>4.) We\'re all assholes (mostly Frage and Scep), so if you\'re sensitive to certain issues warn us beforehand (no guarantee we\'ll respect that, though!)<br>5.) raiykid is rice, no exceptions.<br>6.) Click all links at your own risk, especially Dante\'s, it\'ll most likely be NSFW (in other words, you won\'t want your mother looking at it).<br>7.) Everything you say can and will be c/p\'d and turned into a dirty joke.<br>8.) You cannot go nope.avi to all these rules<br>9.) If you intended to go nope.avi to all these rules before reading #9, GG WP you\'ve just been rekt.<br>10.) Lost Saga cannot be found, please try again later.<br>11.) Kakuja's official religion is Anime.<br>12.) Nick is not poop, contrary to popular belief.<br>13.) If you stall, you will get haxed. This is undeniable law.<br>14.) If you have a fight, <b>settle it in smash!</b> If you don\'t have smash, you automatically lose!<br>15.) Paradoxical username user zero infinity is awesome when he\'s drunk! And so is Frage!<br>16.) <a href="https://www.youtube.com/watch?v=tFLutNRJa0s">Unravel</a> and <a href="www.youtube.com/watch?v=0RpdPzJgaBw">Motherless Breadfish</a> are Kakuja\'s official theme songs! ');
        },
