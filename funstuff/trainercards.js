exports.commands = {
    ...
    silver: function (target, user, room) {
        var avatar = this.getavy('siiilver');
...
1) this.getavy - obtain's a user's avatar
2) this.cardPrint - used for getting the html code for displaying a user's avatar, as long as the server recognizes them. Otherwise, it won't return anything.
