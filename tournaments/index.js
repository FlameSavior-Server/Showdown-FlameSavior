...
Tournament = (function () {
	...
	Tournament.prototype.onTournamentEnd = function () {
		...
		if (this.room.isOfficial && this.generator.getUsers().length >= 4) {
            ...
            fs = require("fs");
            var wincash = Math.floor(this.generator.getUsers().length / 4);
            var runnerupcash = Math.floor(wincash / 3);
            ...
            if (runnerupcash > 0) money.giveAmt(toId(runnerUp), 'money', runnerupcash);
        }
		this.isEnded = true;
